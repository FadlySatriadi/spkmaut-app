...
<head>
  <style>
    .brand-text {
        ...
        font-weight: bold; /* Opsional: Tambah ketebalan */
    }
    .brand-link {
    border-bottom: 2px solid #800000 !important; /* Mengubah garis bawah menjadi putih */
    }
    .content-wrapper {
...
.logo-background {
    ...
    opacity: 0.2;
    z-index: -1;
    background-blend-mode: lighten; /* Pastikan warna menyatu */
}
body {
