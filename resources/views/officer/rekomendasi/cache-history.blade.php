                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; padding: 8px;">
                                            <div class="d-flex justify-content-center">
                                                <!-- Button Detail -->
                                                <a href="{{ route('officer.rekomendasi.cache-history.detail', $history['timestamp']) }}"
                                                ...
                                                <!-- Button Cetak PDF -->
                                                <a href="{{ route('officer.rekomendasi.print-history', $history['timestamp']) }}"
                                                ...
                                                <!-- Button Hapus -->
                                                <form
                                                    action="{{ route('officer.rekomendasi.cache-history.delete', $history['timestamp']) }}"
