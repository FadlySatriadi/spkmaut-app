        ...
        <div class="card-body" style="background-color: beige">
            <div>
                <h4 style="color: #800000;">
                    ...
                    Hai, Officer <strong>{{ Auth::user()->nama ?? 'Pengguna' }}</strong> !
                </h4>
                <p>
        ...
        <div class="card-body" style="background-color: beige">
            <div class="row">
                <div class="col-lg-2 col-6">
                    <!-- small box -->
                    <a href="{{ url('/oplant') }}" class="small-box bg-info">
                        <div class="inner">
                ...
                <div class="col-lg-2 col-6">
                    <a href="{{ url('/oplant?status=aktif') }}" class="small-box bg-success">
                        <div class="inner">
                ...
                <div class="col-lg-2 col-6">
                    <a href="{{ url('/oplant?status=nonaktif') }}" class="small-box bg-warning">
                        <div class="inner">
                ...
                <div class="col-lg-2 col-6">
                    <a href="{{ url('/oplant?kodeaub=sbb') }}" class="small-box bg-danger">
                        <div class="inner">
                ...
                <div class="col-lg-2 col-6">
                    <a href="{{ url('/oplant?kodeaub=vub') }}" class="small-box bg-info">
                        <div class="inner">
                ...
                <div class="card-body" style="background-color: beige">
                    <div class="row">
                        <div class="col-lg-4 col-6">
                            <a href="{{ url('/okriteria') }}" class="small-box bg-warning">
                                <div class="inner">
                        ...
                        <div class="col-lg-4 col-6">
                            <a href="{{ url('/okriteria?jeniskriteria=benefit') }}" class="small-box bg-info">
                                <div class="inner">
                        ...
                        <div class="col-lg-4 col-6">
                            <a href="{{ url('/okriteria?jeniskriteria=cost') }}" class="small-box bg-success">
                                <div class="inner">
                                    <h3 style="text-align: center">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body" style="background-color: beige">
                    <div class="row">
                        <div class="col-lg-4 col-6">
                            <a href="{{ route('officer.rekomendasi.cache-history') }}" class="small-box bg-purple">
                                <div class="inner">
                                    @php
                        ...
                        <div class="col-lg-4 col-6">
                            <a href="{{ route('officer.rekomendasi.cache-history') }}?filter=month" class="small-box bg-info">
                                <div class="inner">
                                    @php
